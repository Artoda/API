...
public class EmprestimoController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Emprestimo> updateEmprestimo(@RequestBody Emprestimo emprestimo,@PathVariable("id") Integer id) {
	...
	public ResponseEntity<Boolean> deleteEmprestimo(@PathVariable Integer id) {
		Boolean resp = emprestimoService.deleteEmprestimo(id);
		if (resp)
