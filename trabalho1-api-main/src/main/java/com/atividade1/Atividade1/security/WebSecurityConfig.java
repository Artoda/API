package com.atividade1.Atividade1.security;
...
import com.atividade1.Atividade1.seguranca.security.service.UserDetailsServiceImpl;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers("/instrutores", "/turmas", "/telefones").hasRole("ADMIN") // autoriza o acesso a rotas por perfil
